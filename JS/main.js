...
sr.reveal(`#hr1`, { delay: 700 });
sr.reveal(`.profile__about`, { delay: 800 });
sr.reveal(`.profile__introduction`, { delay: 900 });
sr.reveal(`.profile__stats`, { delay: 0 });
sr.reveal(`#hr2`, { delay: 0 });
